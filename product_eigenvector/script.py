...
sheet.append(["Product", "Average Time", "Layer 1", "Layer 3", "Layer 4", "Layer 5", "Layer 6"])
sheet.append(["" for i in range(7)])
...
for i in PRODUCTS:
    ...
    sheet.append([i, avg_time[i], l1_ec, l3_ec, l4_ec, l5_ec, l6_ec])
