...
PATH_EDGES = "/home/niit1/PycharmProjects/Data-Mining-Research/eclipse/edges/edges_d1.txt"

with open(PATH_EDGES, 'rb') as fp:
    edges = pickle.load(fp)

PATH_NEIGHBOUR = "/home/niit1/PycharmProjects/Data-Mining-Research/eclipse/neighbours/all_layer_neighbours_d1.txt"
...
with open("combined_local_influence_d1.txt", 'wb') as fp:
    pickle.dump(loc, fp)
