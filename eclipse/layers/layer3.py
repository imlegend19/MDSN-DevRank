...
with db:
    ...
    with open('/home/niit1/PycharmProjects/Data-Mining-Research/eclipse/edges/definition_1/layer3_edges_fc.txt', 'wb') as file:
        pickle.dump(edges, file)

    with open('/home/niit1/PycharmProjects/Data-Mining-Research/eclipse/edges/definition_2/layer3_edges_fc.txt', 'wb') as file:
        pickle.dump(edges, file)
    ...
    # with open(path + "layer_3_degree.txt", 'wb') as fp:
